    ...
    try{
                ...
                if((e.target.Password.value).toString() === (e.target.Confirm_Password.value).toString()){
                  ...
                  axios.post('/api/users/Signup_User',{ 
                    ...
                    mailId: e.target._Email.value.toLowerCase(),
                    referedBy: e.target.Referal_Id.value.toUpperCase(),
    ...
    render(){
             ...
             <div className="wrapper">
                 <div id="formContent">
                   ...
                   {/* <!-- Login Form --> */}
                     ...
                     <select id="country-select" style={{margin:"5px",width:'93%'}} className="browser-default custom-select fadeIn first ">
      ...
      <option value="Zimbabwe">Zimbabwe</option>
                    ...
                    disabled={this.state.Loading}
                     >
                                          {this.state.Loading ? (<div> <Loader type="ThreeDots" color="#FFF" height={15} width={15} /></div>) : "Sign up"}
